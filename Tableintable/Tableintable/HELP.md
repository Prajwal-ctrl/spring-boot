...
* The original package name 'com.example.Patient-data.Tableintable' is invalid and this project uses 'com.example.Patient_data.Tableintable' instead.
...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/docs/3.1.11/reference/htmlsingle/index.html#data.sql.jdbc)
* [Validation](https://docs.spring.io/spring-boot/docs/3.1.11/reference/htmlsingle/index.html#io.validation)
